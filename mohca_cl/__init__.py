...
def init_cli():
  ...
  sandia1_parser.add_argument('der_pf', nargs='?', type=float, default=None, help='Optional DER Power Flow Input - Positive for capacitive, Negative for inductive')
  # nargs="?" - means optional argument but positioned after out_path
  sandia1_parser.add_argument('vv_x', nargs='?', type=list, default=None, help='x coords for volt_var curve')
  sandia1_parser.add_argument('vv_y', nargs='?', type=list, default=None, help='y coords for volt_var curve')
  sandia1_parser.add_argument('load_pf_est', nargs='?', type=float, default=None,)
  ...
  sandiaTCHC_parser.add_argument('der_pf', nargs='?', default=None, help='Optional DER Power Flow Input - Positive for capacitive, Negative for inductive')
  sandiaTCHC_parser.add_argument('vv_x', nargs='?', default=None, help='x coords for volt_var curve')
  sandiaTCHC_parser.add_argument('vv_y', nargs='?', default=None, help='y coords for volt_var curve')
  sandiaTCHC_parser.add_argument('load_pf_est', nargs='?', default=None)
  sandiaTCHC_parser.add_argument('overload_constraint', nargs='?', default=None)
  sandiaTCHC_parser.add_argument('xf_lookup', nargs='?', default=None)
  ...
  isu_transcustmapping_parser.add_argument('minimum_xfmr_n', nargs='?', default=None)
  isu_transcustmapping_parser.add_argument('fmr_n_is_exact,', nargs='?', default=False)
  isu_transcustmapping_parser.add_argument('bus_coords_fp', nargs='?', default=None)
